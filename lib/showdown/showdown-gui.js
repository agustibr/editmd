...
var inputPaneAce,inputPane,previewPane,outputPane,syntaxPane;
...
function startGui() {
	...
	inputPaneAce = document.getElementById("inputPaneAce");
...
function setPaneHeights() {
	...
	// resize all panes
	inputPaneAce.style.height = roomLeft + "px";
